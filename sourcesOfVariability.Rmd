...
peAB[["peptideLog"]] <-
 peAB[["peptideLog"]][rowData(peAB[["peptideLog"]])$Proteins
 %in% smallestUniqueGroups(rowData(peAB[["peptideLog"]])$Proteins),]

peAB[["peptideLog"]] <- peAB[["peptideLog"]][rowData(peAB[["peptideLog"]])$Reverse != "+", ]
peAB[["peptideLog"]] <- peAB[["peptideLog"]][rowData(peAB[["peptideLog"]])$
    Potential.contaminant != "+", ]

peAB[["peptideLog"]] <- peAB[["peptideLog"]][rowData(peAB[["peptideLog"]])$nNonZero >= 2, ]
